...
export default function OTPVerification() {
  ...
  const handleVerify = (e: React.FormEvent) => {
    ...
    // For demo, just navigate to success
    navigate("/success");
  };
              ...
              <div className="flex justify-between gap-4">
                {otp.map((digit, index) => (
                  <input
                    ...
                    className="w-[52px] h-[52px] text-center text-xl font-semibold rounded-xl border border-[#D3E0FE] focus:border-[#4045EF] focus:outline-none transition-colors"
                  />
                ))}
              </div>
